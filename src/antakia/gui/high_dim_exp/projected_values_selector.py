...
class ProjectedValuesSelector:
    ...
    def projection_method(self) -> int:
        ...
        return DimReducMethod.dimreduc_method_as_int(self.projection_select.v_model)
    ...
    def update_params(self, parameter, new_value):
        self.projected_value.set_parameters(self.current_proj, {parameter: new_value})
        self.refresh()
    ...
    def get_current_X_proj(
        self, dim=None, progress_callback: ProgressBar | None = None
    ) -> pd.DataFrame | None:
        """
