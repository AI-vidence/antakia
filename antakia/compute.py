...
from antakia.data import Variable, ExplanationMethod, DimReducMethod, var_from_symbol
...
def skope_rules(df_indexes: list, base_space_df: pd.DataFrame, variables: list = None, precision: float = 0.7, recall: float = 0.7) -> list:
        """
