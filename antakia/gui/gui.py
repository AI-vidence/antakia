...
class GUI:
    ...
    def init_app(self):
        ...
        get_widget(app_widget, "4401100").on_event("click", self.divide_region_clicked)
        # button is disabled by default
        get_widget(app_widget, "4401100").disabled = True

        # We wire events on the 'merge' button:
        get_widget(app_widget, "4401200").on_event("click", self.merge_region_clicked)
        # button is disabled by default
        get_widget(app_widget, "4401200").disabled = True

        # We wire events on the 'delete' button:
        get_widget(app_widget, "4401300").on_event("click", self.delete_region_clicked)
        # The 'delete' button is disabled at startup
        get_widget(app_widget, "4401300").disabled = True
    ...
    def disable_buttons(self, current_operation):
        ...
        get_widget(app_widget, "4401100").disabled = not enable_div

        # merge
        enable_merge = (num_selected_regions > 1) and bool(first_region.num_points() >= config.MIN_POINTS_NUMBER)
        get_widget(app_widget, "4401200").disabled = not enable_merge

        # delete
        get_widget(app_widget, "4401300").disabled = num_selected_regions == 0
