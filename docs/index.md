<img src="img/antakia.svg" alt="AntakIA logo" width="200"/>
...
1. Besides local and global explainability, we believe in a more relevant and intermediate scale to observe phenomena. Through a [**dyadic approach**](regional_explain.md#our-dyadic-approach), it is then possible to divide accordingly the multidimensional space of input values in **regions**, sub-spaces where both the observations, and their explanations are alike.
